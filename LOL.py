...
class minigeneAI:
    ...
    def genetic_search(self, board,my_dol_color):
        ...
        population_size =  [random.sample(moves,2) for _ in range(70)] # 30개의 해를 만듬 각 해는 2개의 수로 이루어짐 30 --> 60 --> 200 --> 110
    ...
    def minimax_search(self, board_tensor, my_dol_color):
        ...
        #이게 1번 과정
        candidates=[]
        for _ in range(100): # 일단 20개로 테스트 20-->70 --> 150 -->100
        ...
        for move in candidates:
            ...
            # 최종점수 내기리
            # 내 점수 - 상대 미래 점수
            final_score = 내보드판현재점수 - (상대점수 * 1.5) # 이1.5 를 조절해서 공격적으로 or 방어적으로로 할 수있음 1.5 -->0.5 --> 1.5
